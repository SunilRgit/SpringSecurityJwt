...
(function ($) {
    ...
    $.fn.draggable = function (_57, _58) {
        ...
        return this.each(function () {
            ...
            _5b._unbind(".draggable")
                ._bind("mousemove.draggable", { target: this }, function (e) {
                    if ($.fn.draggable.isDragging) {
                        return;
                    }
...
(function ($) {
    ...
    $.fn.droppable.defaults = { accept: null, disabled: false, onDragEnter: function (e, _72) {}, onDragOver: function (e, _73) {}, onDragLeave: function (e, _74) {}, onDrop: function (e, _75) {} };
})(jQuery);
(function ($) {
    function _76(e) {
        var _77 = e.data;
    ...
    $.fn.resizable = function (_88, _89) {
        ...
        return this.each(function () {
            ...
            $(this)
                ._bind("mousemove.resizable", { target: this }, function (e) {
...
(function ($) {
    ...
    function _98(_99) {
        ...
        t._unbind(".linkbutton")
            ._bind("focus.linkbutton", function () {
                if (!_9a.disabled) {
    ...
    $.fn.linkbutton.parseOptions = function (_ab) {
        var t = $(_ab);
        return $.extend({}, $.parser.parseOptions(_ab, ["id", "iconCls", "iconAlign", "group", "size", "text", { plain: "boolean", toggle: "boolean", selected: "boolean", outline: "boolean" }]), {
...
(function ($) {
    function _ac(_ad) {
        ...
        function _b4(_b6) {
            ...
            a.wrap("<td></td>");
            a.linkbutton({ iconCls: btn.iconCls, plain: true })
                ._unbind(".pagination")
                ._bind("click.pagination", function () {
...
(function ($) {
    ...
    function _1f6(_1f7) {
        ...
        $(_1f7)
            ._unbind(".tooltip")
            ._bind(opts.showEvent + ".tooltip", function (e) {
                $(_1f7).tooltip("show", e);
            })
            ...
            if (pos.left < 0) {
                ...
                if (pos.left + tip._outerWidth() > $(window)._outerWidth() + $(document)._scrollLeft()) {
                    if (opts.position == "right") {
                        ...
                        $(_1fc)
                            .tooltip("arrow")
                            .css("left", tip._outerWidth() / 2 - (pos.left - left));
                    }
                }
            }
        }
    ...
    $.fn.tooltip.parseOptions = function (_215) {
        var t = $(_215);
        var opts = $.extend({}, $.parser.parseOptions(_215, ["position", "showEvent", "hideEvent", "content", { trackMouse: "boolean", deltaX: "number", deltaY: "number", showDelay: "number", hideDelay: "number" }]), {
            _title: t.attr("title"),
        });
        t.attr("title", "");
        if (!opts.content) {
...
(function ($) {
    ...
    function _2bc(_2bd, _2be) {
        ...
        bb.insertAfter(_2bd);
        tb.add(bb)
            ._outerWidth(t._outerWidth())
            .find(".easyui-fluid:visible")
            .each(function () {
                $(this).triggerHandler("_resize");
            });
...
(function ($) {
    function _2cb() {
        $(document)
            ._unbind(".messager")
            ._bind("keydown.messager", function (e) {
                if (e.keyCode == 27) {
                    $("body")
                        .children("div.messager-window")
                        .children("div.messager-body")
                        .each(function () {
                            $(this).dialog("close");
                        });
                } else {
    ...
    $.messager = {
        ...
        progress: function (_2dc) {
            ...
            var dlg = _2d3(
                $.extend({}, $.messager.defaults, { content: '<div class="messager-progress"><div class="messager-p-msg">' + opts.msg + '</div><div class="messager-p-bar"></div></div>', closable: false, doSize: false }, opts, {
                    onClose: function () {
                        if (this.timer) {
...
(function ($) {
    function _2df(_2e0) {
        ...
        $(_2e0)
            .dialog("header")
            .find(".panel-tool-collapse")
            .addClass("layout-button-" + (opts.region == "east" ? "right" : "left"))
            ._unbind()
        ...
        $(_2e0)
            .dialog("dialog")
            .css({ display: "", left: opts.region == "east" ? "auto" : -_2e1, right: opts.region == "east" ? -_2e1 : "auto" });
        var mask = $(_2e0).data("window").mask;
        $(mask)
            .addClass("drawer-mask")
            .hide()
            ._unbind()
            ._bind("click", function () {
                _2e2(_2e0);
    ...
    function _2e3(_2e4) {
        ...
        $(_2e4)
            ...
            .css({ display: "" })
            .dialog("dialog")
            .animate({ left: opts.region == "east" ? "auto" : 0, right: opts.region == "east" ? 0 : "auto" }, function () {
    ...
    function _2e2(_2e6) {
        ...
        $(_2e6)
            ...
            .css({ display: "" })
            .dialog("dialog")
            .animate({ left: opts.region == "east" ? "auto" : -_2e7, right: opts.region == "east" ? -_2e7 : "auto" }, function () {
...
(function ($) {
    ...
    function _310(_311, pp, _312) {
        ...
        pp.panel(
            $.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body", halign: opts.halign }, _312, {
                onBeforeExpand: function () {
    ...
    function _369(_36a) {
        ...
        $(
            '<div class="tabs-header">' +
                ...
                '<div class="tabs-wrap">' +
                '<ul class="tabs"></ul>' +
                '<i class="typcn typcn-refresh refreshIcon" onClick="tabRefresh();" title="Refresh"></i>' +
                "</div>" +
                "</div>"
        ).prependTo(_36a);
        cc.children("div.tabs-panels")
            .children("div")
            .each(function (i) {
        ...
        cc.children("div.tabs-header")
            .find(".tabs-scroller-left, .tabs-scroller-right")
            ._bind("mouseenter", function () {
    ...
    function _378(_379, _37a, pp) {
        ...
        pp.panel(
            $.extend({}, _37a, {
                ...
                closed: true,
                doSize: false,
                iconCls: _37a.icon ? _37a.icon : undefined,
                onLoad: function () {
                    if (_37a.onLoad) {
...
(function ($) {
    ...
    function _3e4(_3e5, _3e6, el) {
        ...
        var _3e8 = $.extend(
            ...
            _3e6,
            { cls: (_3e6.cls || "") + " layout-panel layout-panel-" + dir, bodyCls: (_3e6.bodyCls || "") + " layout-body" }
        );
        pp.panel(_3e8);
        _3e7[dir] = pp;
    ...
    function _401(_402, _403, _404) {
            ...
            if (!_407.expandMode) {
                ...
                ep._bind("click", function () {
                    if (_407.expandMode == "dock") {
                        ...
                        p.panel("panel")
                            ._unbind(".layout")
                            ._bind("mouseleave.layout", { region: _403 }, function (e) {
                                var that = this;
        ...
        function _409(dir) {
            ...
            p.panel(
                $.extend({}, $.fn.layout.paneldefaults, {
                    ...
                    title: "&nbsp;",
                    titleDirection: _407.titleDirection,
                    iconCls: _407.hideCollapsedContent ? null : _407.iconCls,
                    closed: true,
                    minWidth: 0,
                    minHeight: 0,
                    doSize: false,
                    region: _407.region,
                    collapsedSize: _407.collapsedSize,
                    noheader: !isns && _407.hideExpandTool,
                    tools:
                        isns && _407.hideExpandTool
                            ? null
                            : [
                                  {
                                      iconCls: icon,
        ...
        function _40b() {
            ...
            if (_403 == "east") {
                ...
                return {
                    resizeC: { width: _414 },
                    expand: { left: cc.width() - _413 },
                    expandP: { top: _411.top, left: cc.width() - _412, width: _412, height: _411.height },
                    collapse: { left: cc.width(), top: _411.top, height: _411.height },
                };
            } else {
                if (_403 == "west") {
                    var _413 = p.panel("panel")._outerWidth();
                    ...
                    if (_403 == "north") {
                        ...
                        _406.east
                            ...
                            .add(_406.expandEast)
                            .add(_406.expandWest)
                            .panel("resize", { top: _412 - 1, height: hh });
    ...
    $.fn.layout.defaults = { fit: false, onExpand: function (_437) {}, onCollapse: function (_438) {}, onAdd: function (_439) {}, onRemove: function (_43a) {} };
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        ...
        collapsedContent: function (_43c) {
            var p = $(this);
...
(function ($) {
    $(function () {
        $(document)
            ._unbind(".menu")
            ._bind("mousedown.menu", function (e) {
    ...
    function _446(_449, div, _44a) {
        ...
        var _44b = $.extend(
            {},
            $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", { separator: "boolean" }]),
            { disabled: item.attr("disabled") ? true : undefined, text: $.trim(item.html()), onclick: item[0].onclick },
            _44a || {}
        );
    ...
    function _447(_44d, menu) {
        ...
        menu.find(".menu-item").each(function () {
            ...
            $(this)
                .find(".menu-text")
                .css({ height: opts.itemHeight - 2 + "px", lineHeight: opts.itemHeight - 2 + "px" });
        });
    ...
    $.fn.menu.defaults = {
        ...
        fit: false,
        noline: false,
        events: { mouseenter: _457, mouseleave: _45a, mouseover: _45e, mouseout: _461, click: _463 },
        position: function (_49e, left, top) {
            return { left: left, top: top };
        },
        onShow: function () {},
        onHide: function () {},
    ...
    function _4a8(_4a9, _4aa, data) {
        ...
        $(_4aa).tooltip({
            ...
            onShow: function () {
                ...
                tip.add(tip.find("ul.tree"))
                    ._unbind(".sidemenu")
                    ._bind("mouseover.sidemenu", function () {
                        t.tooltip("show");
                    })
...
(function ($) {
    ...
    function _4e8(_4e9, _4ea) {
        ...
        _4ec.find(".switchbutton-handle")
            ._outerWidth(_4ee)
            ._outerHeight(h)
            .css({ marginLeft: -_4ee / 2 + "px" });
    ...
    function _50a(_50b) {
        ...
        _50c.switchbutton
            ._unbind(".switchbutton")
            ._bind("click.switchbutton", function () {
    ...
    $.fn.switchbutton.parseOptions = function (_513) {
        var t = $(_513);
        return $.extend({}, $.parser.parseOptions(_513, ["onText", "offText", "handleText", { handleWidth: "number", reversed: "boolean" }, "label", "labelPosition", "labelAlign", { labelWidth: "number" }]), {
...
(function ($) {
    ...
    $.fn.radiobutton.parseOptions = function (_539) {
        var t = $(_539);
        return $.extend({}, $.parser.parseOptions(_539, ["label", "labelPosition", "labelAlign", { labelWidth: "number" }]), {
            value: t.val() || undefined,
            checked: t.attr("checked") ? true : undefined,
            disabled: t.attr("disabled") ? true : undefined,
            readonly: t.attr("readonly") ? true : undefined,
...
(function ($) {
    ...
    $.fn.checkbox.parseOptions = function (_55f) {
        var t = $(_55f);
        return $.extend({}, $.parser.parseOptions(_55f, ["label", "labelPosition", "labelAlign", { labelWidth: "number" }]), {
            value: t.val() || undefined,
            checked: t.attr("checked") ? true : undefined,
            disabled: t.attr("disabled") ? true : undefined,
            readonly: t.attr("readonly") ? true : undefined,
...
(function ($) {
    ...
    function _562(_563) {
        ...
        for (var i = 0; i < opts.data.length; i++) {
            ...
            rb.radiobutton(
                $.extend({}, { labelWidth: opts.labelWidth, labelPosition: opts.labelPosition, labelAlign: opts.labelAlign }, opts.data[i], {
...
(function ($) {
    ...
    $.fn.validatebox.parseOptions = function (_5b7) {
        ...
        return $.extend(
            ...
            { required: t.attr("required") ? true : undefined, disabled: t.attr("disabled") ? true : undefined, readonly: t.attr("readonly") ? true : undefined, novalidate: t.attr("novalidate") != undefined ? true : undefined }
        );
    };
...
(function ($) {
    ...
    function _5c6(_5c7) {
        ...
        $("#" + _5c9)
            .attr("tabindex", $(_5c7).attr("tabindex") || "")
            .css("text-align", _5c7.style.textAlign || "");
    ...
    $.fn.textbox.parseOptions = function (_61e) {
        ...
        return $.extend(
            {},
            $.fn.validatebox.parseOptions(_61e),
            $.parser.parseOptions(_61e, [
                "prompt",
                "iconCls",
                "iconAlign",
                "buttonText",
...
(function ($) {
    function _626(_627) {
        ...
        $(_627)
            .addClass("passwordbox-f")
            .textbox($.extend({}, opts, { icons: _629 }));
        _62a(_627);
    }
    ...
    function _62a(_630, _631) {
        ...
        t.textbox("setText", opts.revealed ? _631 : _631.replace(/./gi, _632));
...
(function ($) {
    function _67a(_67b) {
        ...
        var _67f = _680();
        $(_67b)
            .addClass("searchbox-f")
            .textbox($.extend({}, opts, { icons: _67d, buttonText: _67f ? _67f.text : "" }));
        ...
        function _681(item) {
            ...
            $(_67b)
                .textbox("button")
                .menubutton({ text: item.text, iconCls: item.iconCls || null, menu: _67c.menu, menuAlign: opts.buttonAlign, duration: opts.duration, showEvent: opts.showEvent, hideEvent: opts.hideEvent, plain: false });
...
(function ($) {
    function _68b(_68c, _68d) {
        ...
        if (opts.dirty) {
            ...
            _690 = $(_68c)
                .find("input[name]:enabled,textarea[name]:enabled,select[name]:enabled")
                .filter(function () {
    ...
    function _691(_693, _694) {
        ...
        function _697(_698) {
            ...
            try {
                for (var n in _698) {
                    var _69a = $('<input type="hidden" name="' + n + '">')
                        .val(_698[n])
                        .appendTo(form);
                    _699 = _699.add(_69a);
                }
    ...
    function _6b4(_6b5) {
        ...
        $(_6b5)
            .bind("_change.form", function (e, t) {
    ...
    function _6b7(_6bf, _6c0) {
        ...
        $(_6bf)
            .find(".validatebox-text:not(:disabled)")
            .validatebox(_6c0 ? "disableValidation" : "enableValidation");
    }
...
(function ($) {
    ...
    $.fn.numberbox.parseOptions = function (_6d8) {
        var t = $(_6d8);
        return $.extend({}, $.fn.textbox.parseOptions(_6d8), $.parser.parseOptions(_6d8, ["decimalSeparator", "groupSeparator", "suffix", { min: "number", max: "number", precision: "number" }]), {
...
(function ($) {
    ...
    function _6e1(_6e2) {
        ...
        menu.find(".calendar-menu-year")
            ._unbind(".calendar")
            ._bind("keypress.calendar", function (e) {
                if (e.keyCode == 13) {
                    _6e3(true);
                }
            });
        $(_6e2)
            ._unbind(".calendar")
            ._bind("mouseover.calendar", function (e) {
                var t = _6e4(e.target);
    ...
    function show(_6fb) {
        ...
        $(_6fb)
            .find(".calendar-title span")
            .html(opts.months[opts.month - 1] + " " + opts.year);
...
(function ($) {
    function _70f(_710) {
        ...
        if (opts.spinArrow) {
            ...
            _71a.append(
                '<span class="spinner-arrow spinner-button-top">' + '<span class="spinner-arrow-up"></span>' + "</span>" + '<span class="spinner-arrow spinner-button-bottom">' + '<span class="spinner-arrow-down"></span>' + "</span>"
            );
        } else {
    ...
    $.fn.spinner.defaults = $.extend({}, $.fn.textbox.defaults, { min: null, max: null, increment: 1, spinAlign: "right", reversed: false, spin: function (down) {}, onSpinUp: function () {}, onSpinDown: function () {} });
})(jQuery);
(function ($) {
    function _724(_725) {
        ...
        $(_725)
            .numberbox($.extend({}, opts, { doSize: false }))
            .spinner(opts);
...
(function ($) {
    ...
    function _76e(_76f) {
        ...
        _773.add(_774)
            ...
            .css({ marginTop: _77a, height: isNaN(parseInt(opts.height)) ? "" : _772 - _77b, minHeight: _77d ? _77d - _77c - _77b : "", maxHeight: _77e ? _77e - _77c - _77b : "" });
    ...
    function _794(_795, _796) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _79b,
                view2: _79c,
                header1: _79b.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _79c.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _79b.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _79c.children("div.datagrid-body"),
                footer1: _79b.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _79c.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
            },
        };
    }
    function _79d(_79e) {
        ...
        if (opts.pagination) {
            ...
            _7a6.pagination({
                ...
                onSelectPage: function (_7a7, _7a8) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            ...
                            $('<div class="datagrid-cell-group"></div>')
                                .html(col.hformatter ? col.hformatter(col.title, col) : col.title)
                                .appendTo(td);
                        }
                    }
                    if (col.hidden) {
        ...
        function _769(_817) {
            ...
            function _81a(type) {
                ...
                if (type == "header") {
                    ...
                    opts.finder
                        .getTr(_812, 0, type)
                        .find('td[field="' + _817 + '"] div.datagrid-cell')
                        .each(function () {
                            var w = _81c($(this));
                            if (_81b < w) {
                                _81b = w;
    ...
    var _900 = $.extend({}, _8f2(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_901, _902) {
    ...
    $.fn.datagrid.parseOptions = function (_946) {
        ...
        return $.extend(
            {},
            $.fn.panel.parseOptions(_946),
            $.parser.parseOptions(_946, [
                "url",
                "toolbar",
                "idField",
                "sortName",
            ...
            { pageList: t.attr("pageList") ? eval(t.attr("pageList")) : undefined, loadMsg: t.attr("loadMsg") != undefined ? t.attr("loadMsg") : undefined, rowStyler: t.attr("rowStyler") ? eval(t.attr("rowStyler")) : undefined }
        );
    };
    ...
    var _949 = {
        render: function (_94a, _94b, _94c) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 31,
        headerEvents: { mouseover: _7c1(true), mouseout: _7c1(false), click: _7c5, dblclick: _7ca, contextmenu: _7cd },
        rowEvents: { mouseover: _7cf(true), mouseout: _7cf(false), click: _7d6, dblclick: _7e0, contextmenu: _7e4 },
        rowStyler: function (_990, _991) {},
        ...
        editors: _900,
        finder: {
            getTr: function (_995, _996, type, _997) {
                type = type || "body";
                _997 = _997 || 0;
...
(function ($) {
    var _9ca;
    $(document)
        ._unbind(".propertygrid")
        ._bind("mousedown.propertygrid", function (e) {
    ...
    function _9cc(_9cd) {
        ...
        $(_9cd).datagrid(
            $.extend({}, opts, {
                ...
                onBeforeEdit: function (_9cf, row) {
    ...
    var _9db = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9dc, _9dd, _9de) {
            var _9df = [];
                ...
                if (!$("#datagrid-group-style").length) {
                    $("head").append(
                        '<style id="datagrid-group-style">' +
                            ...
                            ".datagrid-group-expander .datagrid-row-expander{margin:" +
                            Math.floor((opts.groupHeight - 16) / 2) +
    ...
    $.extend(_9db, {
        refreshGroupTitle: function (_a11, _a12) {
            ...
            var span = dc.body1
                .add(dc.body2)
                .children("div.datagrid-group[group-index=" + _a12 + "]")
                .find("span.datagrid-group-title");
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupView: _9db,
        groupField: "group",
        groupStyler: function (_a30, rows) {
            return "";
        },
...
(function ($) {
    function _a32(_a33) {
        ...
        if (opts.pagination) {
            ...
            _a3f.pagination({
                ...
                pageSize: opts.pageSize,
                pageList: opts.pageList,
                onSelectPage: function (_a40, _a41) {
    ...
    var _ad8 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_ad9, _ada, _adb) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _ad8,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _a4d(true), mouseout: _a4d(false), click: _a4f }),
        loader: function (_b16, _b17, _b18) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
        ...
        finder: {
            getTr: function (_b1a, id, type, _b1b) {
                type = type || "body";
                _b1b = _b1b || 0;
...
(function ($) {
                              ...
                              [
                                  {
                                      ...
                                      width: "100%",
                                      formatter: function (_b26, row, _b27) {
    ...
    var _b28 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b29, _b2a, _b2b) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupField: "",
        view: _b28,
        textFormatter: function (_b44, row) {
            return _b44;
        },
...
(function ($) {
    $(function () {
        $(document)
            ._unbind(".combo")
            ._bind("mousedown.combo mousewheel.combo", function (e) {
    ...
    function _b47(_b48) {
        ...
        $(_b48)
            .addClass("combo-f")
            .textbox($.extend({}, opts, { icons: _b4e, onChange: function () {} }));
    ...
    function _b63(_b64) {
        ...
        if (_b68.closed) {
            _b67.panel("panel")
                .show()
                .css({ zIndex: $.fn.menu ? $.fn.menu.defaults.zIndex++ : $.fn.window ? $.fn.window.defaults.zIndex++ : 99, left: -999999 });
    ...
    $.fn.combo.parseOptions = function (_b8f) {
        ...
        return $.extend(
            {},
            $.fn.textbox.parseOptions(_b8f),
            $.parser.parseOptions(_b8f, [
                "separator",
                "panelAlign",
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _b59, keydown: _b5d, paste: _b5d, drop: _b5d, blur: _b60 },
        panelEvents: {
        ...
        hasDownArrow: true,
        delay: 200,
        keyHandler: { up: function (e) {}, down: function (e) {}, left: function (e) {}, right: function (e) {}, enter: function (e) {}, query: function (q, e) {} },
...
(function ($) {
    ...
    function _bcd(e) {
        ...
        if (opts.groupPosition == "sticky") {
            ...
            $(this)
                .children(".combobox-group:visible")
                .each(function () {
                    var g = $(this);
    ...
    var _be3 = 0;
    var _be4 = {
        render: function (_be5, _be6, data) {
    ...
    function _c29(_c2a) {
        ...
        grid.datagrid(
            $.extend({}, opts, {
                ...
                onLoadSuccess: _c30,
                onClickRow: _c31,
                onSelect: _c32("onSelect"),
                onUnselect: _c32("onUnselect"),
                onSelectAll: _c32("onSelectAll"),
                onUnselectAll: _c32("onUnselectAll"),
            })
        );
        function _c33(dg) {
...
(function ($) {
    function _cd3(_cd4) {
        ...
        if (!_cd5.calendar) {
            ...
            $.extend(_cd5.calendar.calendar("options"), {
                fit: true,
                border: false,
                onSelect: function (date) {
        ...
        function _cd7(_cde) {
            ...
            for (var i = 0; i < opts.buttons.length; i++) {
                ...
                var t = $('<a class="datebox-button-a" href="javascript:;"></a>')
                    .html($.isFunction(btn.text) ? btn.text(_cde) : btn.text)
                    .appendTo(td);
        ...
        buttons: [
            {
                ...
                handler: function (_cf9) {
                    ...
                    $(_cf9)
                        .datebox("calendar")
                        .calendar({ year: _cfa.getFullYear(), month: _cfa.getMonth() + 1, current: _cfa });
    ...
    function _d21(_d22) {
        ...
        function _d25(_d29) {
            ...
            for (var i = 0; i < opts.buttons.length; i++) {
                ...
                var btn = opts.buttons[i];
                var t = $('<a class="datebox-button-a" href="javascript:;"></a>')
                    .html($.isFunction(btn.text) ? btn.text(_d29) : btn.text)
                    .appendTo(td);
                t.attr("datebox-button-index", i);
            }
            tr.find("td").css("width", 100 / opts.buttons.length + "%");
    ...
    function _d3a(_d3d) {
        ...
        $(
            '<div class="panel-header f-noshrink f-row f-content-center">' +
                '<div class="title title-hour">' +
                (hour < 10 ? "0" + hour : hour) +
                "</div>" +
                '<div class="sep">:</div>' +
                '<div class="title title-minute">' +
                (_d40 < 10 ? "0" + _d40 : _d40) +
                "</div>" +
                '<div class="ampm f-column">' +
                '<div class="title title-am">' +
                opts.ampm[0] +
                "</div>" +
                '<div class="title title-pm">' +
                opts.ampm[1] +
                "</div>" +
                "</div>" +
                "</div>"
...
(function ($) {
    ...
    function _d6d(_d6e) {
        ...
        _d70.find("a.slider-handle").draggable({
            axis: opts.mode,
            cursor: "pointer",
        ...
        _d70.find("div.slider-inner")
            ._unbind(".slider")
            ._bind("mousedown.slider", function (e) {
    ...
    $.fn.slider.parseOptions = function (_d95) {
        var t = $(_d95);
        return $.extend({}, $.parser.parseOptions(_d95, ["width", "height", "mode", { reversed: "boolean", showTip: "boolean", range: "boolean", min: "number", max: "number", step: "number" }]), {
            value: t.val() || undefined,
            disabled: t.attr("disabled") ? true : undefined,
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_d96) {
            return _d96;
        },
        converter: {
            toPosition: function (_d97, size) {
                var opts = $(this).slider("options");
